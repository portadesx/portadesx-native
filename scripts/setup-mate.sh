...
apt install -y tigervnc mate-* marco mate-terminal caja termux-x11 nano wget curl pulseaudio pavucontrol gvfs

# Install user apps
apt install -y firefox chromium thunderbird xarchiver ristretto galculator atril mousepad vlc-qt ristretto
...
ln -s /data/data/com.termux/files/usr/share/applications/mate-terminal.desktop /data/data/com.termux/files/home/Desktop/mate-terminal.desktop
ln -s /data/data/com.termux/files/usr/share/applications/atril.desktop /data/data/com.termux/files/home/Desktop/atril.desktop
